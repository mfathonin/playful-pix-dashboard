...
<div
	role="button"
	tabindex="0"
	class="flex gap-10 items-center justify-between rounded-lg p-4 w-full border border-surface-200-700-token hover:border-surface-400-500-token cursor-pointer"
